...
a = arr.filter(item => item.completed === true);

b = arr.filter(item => item.completed === false);

a.count = arr.filter(item => item.completed === true);
b.count = arr.filter(item => item.completed === false)
console.log(a, b);